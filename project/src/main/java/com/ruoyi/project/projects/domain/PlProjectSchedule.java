...
public class PlProjectSchedule extends BaseEntity {
     ...
     * 是否为 里程碑 0 不是 默认 1 是
     */
    @ApiModelProperty(value = "是否为 里程碑 0 不是 默认 1 是")
    @Excel(name = "是否为 里程碑 0 不是 默认 1 是")
    private String milestoneFlag;

    /**
     * 进度是否完成 0 未完成 默认  1 完成    需手动修改表单
     */
    @ApiModelProperty(value = "进度是否完成 0 未完成 默认  1 完成    需手动修改表单")
    @Excel(name = "进度是否完成 0 未完成 默认  1 完成    需手动修改表单")
